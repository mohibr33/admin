...
export default function Container({ children = [], options, additionalClassNames = "" }) {
 ...
 {/* <button
   ...
   className=" flex items-center justify-center  py-2 border-solid border-2 font-bold border-black" style={{width:"80px"}}
 >
   Add User
 </button> */}
 <div>
 ...
 className="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-3 rounded-lg text-sm  ">
    Add User
  </button> */}
 </div>
